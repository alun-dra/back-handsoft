...
func CountryIDGT(v int) predicate.Region {
	return predicate.Region(sql.FieldGT(FieldCountryID, v))
}

// CountryIDGTE applies the GTE predicate on the "country_id" field.
func CountryIDGTE(v int) predicate.Region {
	return predicate.Region(sql.FieldGTE(FieldCountryID, v))
}

// CountryIDLT applies the LT predicate on the "country_id" field.
func CountryIDLT(v int) predicate.Region {
	return predicate.Region(sql.FieldLT(FieldCountryID, v))
}

// CountryIDLTE applies the LTE predicate on the "country_id" field.
func CountryIDLTE(v int) predicate.Region {
	return predicate.Region(sql.FieldLTE(FieldCountryID, v))
}
