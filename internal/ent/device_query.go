...
func (_q *DeviceQuery) QueryAccessPoint() *AccessPointQuery {
...
func (_q *DeviceQuery) WithAccessPoint(opts ...func(*AccessPointQuery)) *DeviceQuery {
	query := (&AccessPointClient{config: _q.config}).Query()
...
//
//	client.Device.Query().
//		GroupBy(device.FieldAccessPointID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Device.Query().
//		Select(device.FieldAccessPointID).
//		Scan(ctx, &v)
...
func (_q *DeviceQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Device, error) {
	...
	if query := _q.withAccessPoint; query != nil {
		if err := _q.loadAccessPoint(ctx, query, nodes, nil,
			func(n *Device, e *AccessPoint) { n.Edges.AccessPoint = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *DeviceQuery) loadAccessPoint(ctx context.Context, query *AccessPointQuery, nodes []*Device, init func(*Device), assign func(*Device, *AccessPoint)) error {
...
func (_q *DeviceQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withAccessPoint != nil {
			_spec.Node.AddColumnOnce(device.FieldAccessPointID)
		}
	}
